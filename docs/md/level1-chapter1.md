...
| Enterprise / Anthropic API | Sonnet 4.6 (2026-04-23부터 Opus 4.7로 변경) |
...
→ Natural Text Editing 적용 (Option+← / Option+→ 단어 이동)
```
