...
### 1.2.3 Opus 4.8 · Sonnet 4.6 · Haiku 4.5 비교 · 용도별 모델 선택 가이드, 요금제 비교
...
> **주의**: Opus 4.8은 `temperature`, `top_p`, `top_k` 파라미터를 제거했다 (설정 시 400 에러). API로 직접 사용하는 경우 마이그레이션 필요.
...
상황 4: 복잡한 추론이 필요한 작업
→ /effort xhigh (Opus 4.8) 또는 Option+T 로 Thinking 토글
```
...
> - ✅ 모델 버전 (Opus 4.8, Sonnet 4.6, Haiku 4.5): 공식 문서 및 시스템 컨텍스트 일치  
> - ✅ Opus 4.8 출시일 2026-05-28, SWE-bench Verified 88.6%·기본 effort `high`(`xhigh` 지원)·`temperature` 등 제거: 공식 모델 노트 확인  
