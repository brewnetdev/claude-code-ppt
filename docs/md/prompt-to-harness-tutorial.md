...
> - `![...](images/xxx.svg)` — 이 문서와 함께 생성된 도식. 그대로 사용.
...
![엄밀함의 이동 — 세 시대 타임라인](images/rigor-relocation-timeline.svg)
...
![프롬프팅 기법 선택 가이드](images/prompt-techniques-decision-tree.svg)
...
![컨텍스트 윈도우 구조와 KV-cache](images/context-window-layout.svg)
...
![하네스의 네 사분면](images/harness-quadrants.svg)
...
![치명적 3요소와 2의 규칙](images/lethal-trifecta.svg)
...
![claude-code-ppt 하네스 구축 지도](images/project-harness-map.svg)
